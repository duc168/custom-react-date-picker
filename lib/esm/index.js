...
var TableContent = function (_a) {
    ...
    return (React.createElement("div", { className: styles$9.container }, dateList.map(function (d) {
        return (React.createElement("div", { key: d.id, className: styles$9.item + " " + getStyles(d.status), onClick: function () { return onClick(d); } },
            React.createElement("div", { className: styles$9.textContainer },
                React.createElement("div", { className: styles$9.text }, d.text))));
    })));
};
...
var TableHeader = function () {
    return React.createElement("div", { className: styles$8.container }, DAY_FORMAT_2_LETTERS.map(function (d) {
        return React.createElement("div", { key: d, className: styles$8.dayName }, d);
    }));
};
...
var Header$2 = function (_a) {
    ...
    return React.createElement("div", { className: styles$6.container },
        React.createElement("div", { className: styles$6.leftArrow },
            React.createElement("button", { className: styles$6.button, onClick: goToPreviousMonth },
                React.createElement(LeftArrowIcon, null))),
        React.createElement("div", { className: styles$6.text }, monthYearString),
        React.createElement("div", { className: styles$6.rightArrow },
            React.createElement("button", { className: styles$6.button, onClick: goToNextMonth },
...
var Header$1 = function (_a) {
    var _b;
    var data = _a.data;
    return React.createElement("div", { className: styles$4.container }, (_b = data.label.fromTimeLabel) !== null && _b !== void 0 ? _b : 'Select Time');
};
...
var Content$1 = function (_a) {
    ...
    return React.createElement("div", { className: styles$3.container }, fromTimeList.map(function (t) {
        return React.createElement("div", { className: styles$3.item + " " + getStyles(t.status), key: t.id, onClick: function () { return onClick(t); } }, t.text);
    }));
};
...
var Content = function (_a) {
    ...
    return React.createElement("div", { className: styles$3.container }, toTimeList.map(function (t) {
        return React.createElement("div", { className: styles$3.item + " " + getStyles(t.status), key: t.id, onClick: function () { return onClick(t); } }, t.text);
    }));
};
...
var DatePicker = function (_a) {
    ...
    return React.createElement("div", { className: styles.container + " " + (status ? styles.show : styles.hide) },
        React.createElement(MainContainer, { data: data }));
};

...
var useDatePicker$1 = function (_a) {
    var _b = _a.minDate, minDate = _b === void 0 ? addDays(new Date(), -1) : _b, _c = _a.maxDate, maxDate = _c === void 0 ? new Date(2021, 11, 1) : _c, _d = _a.minTime, minTime = _d === void 0 ? setSeconds(setMinutes(setHours(new Date(), 0), 0), 0) : _d, _e = _a.maxTime, maxTime = _e === void 0 ? setSeconds(setMinutes(setHours(new Date(), 23), 0), 0) : _e, fromTimeLabel = _a.fromTimeLabel, toTimeLabel = _a.toTimeLabel, timeLabel = _a.timeLabel, _f = _a.timeType, timeType = _f === void 0 ? 24 : _f, onSelectDate = _a.onSelectDate, onSelectTime = _a.onSelectTime, onSelectFromTime = _a.onSelectFromTime, onSelectToTime = _a.onSelectToTime;

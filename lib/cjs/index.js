...
var Header = function (_a) {
    ...
    return React__default['default'].createElement("div", { className: styles$4.container },
        React__default['default'].createElement("div", { className: styles$4.leftArrow },
            React__default['default'].createElement("button", { className: styles$4.button, onClick: goToPreviousMonth },
                React__default['default'].createElement(LeftArrowIcon, null))),
        React__default['default'].createElement("div", { className: styles$4.text }, monthYearString),
        React__default['default'].createElement("div", { className: styles$4.rightArrow },
            React__default['default'].createElement("button", { className: styles$4.button, onClick: goToNextMonth },
...
var TableContent = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: styles$3.container }, dateList.map(function (d) {
        return (React__default['default'].createElement("div", { key: d.id, className: styles$3.item + " " + getStyles(d.status), onClick: function () { return onClick(d.text); } },
            React__default['default'].createElement("div", { className: styles$3.textContainer },
                React__default['default'].createElement("div", { className: styles$3.text }, d.text))));
    })));
};
...
var TableHeader = function () {
    return React__default['default'].createElement("div", { className: styles$2.container }, DAY_FORMAT_2_LETTERS.map(function (d) {
        return React__default['default'].createElement("div", { key: d, className: styles$2.dayName }, d);
    }));
};
...
var useDatePicker$1 = function () {
    var _a = React.useState(false), status = _a[0], setStatus = _a[1];
    var _b = React.useState(0), selectedYear = _b[0], setSelectedYear = _b[1];
    var _c = React.useState(0), selectedMonth = _c[0], setSelectedMonth = _c[1];
    var _d = React.useState(0), selectedDate = _d[0], setSelectedDate = _d[1];
    var _e = React.useState(0), valueYear = _e[0], setValueYear = _e[1];
    var _f = React.useState(0), valueMonth = _f[0], setValueMonth = _f[1];
    var _g = React.useState(0), valueDate = _g[0], setValueDate = _g[1];
    React.useEffect(function () {
        var now = new Date();

...
var TableContent = function (_a) {
    ...
    var getStyles = function (status) {
        switch (status) {
            case "disable":
                return styles$9.disabled;
            case "hide":
                return styles$9.hide;
            case "show":
                return styles$9.show;
            case "selected":
                return styles$9.selected;
            default:
                return styles$9.hide;
        }
    };
    ...
    return (React__default['default'].createElement("div", { className: styles$9.container }, dateList.map(function (d) {
        return (React__default['default'].createElement("div", { key: d.id, className: styles$9.item + " " + getStyles(d.status), onClick: function () { return onClick(d); } },
            React__default['default'].createElement("div", { className: styles$9.textContainer },
                React__default['default'].createElement("div", { className: styles$9.text }, d.text))));
    })));
};
...
var css_248z$8 = ".styles-module_container__2suYF {\n  display: grid;\n  grid-template-columns: 40px 40px 40px 40px 40px 40px 40px;\n  font-style: normal;\n  font-weight: 500;\n  font-size: 12px;\n  line-height: 20px;\n  color: #555555;\n}\n.styles-module_container__2suYF .styles-module_dayName__R_2Jx {\n  height: 40px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}";
var styles$8 = {"container":"styles-module_container__2suYF","dayName":"styles-module_dayName__R_2Jx"};
styleInject(css_248z$8);

var TableHeader = function () {
    return React__default['default'].createElement("div", { className: styles$8.container }, DAY_FORMAT_2_LETTERS.map(function (d) {
        return React__default['default'].createElement("div", { key: d, className: styles$8.dayName }, d);
    }));
};

var css_248z$7 = ".styles-module_container__3RwAO {\n  position: relative;\n  padding: 8px;\n  background: rgba(255, 255, 255, 0.96);\n  box-shadow: 0px 33px 30px rgba(0, 0, 0, 0.02);\n  backdrop-filter: blur(8px);\n}";
var styles$7 = {"container":"styles-module_container__3RwAO"};
...
var Header$2 = function (_a) {
    ...
    return React__default['default'].createElement("div", { className: styles$6.container },
        React__default['default'].createElement("div", { className: styles$6.leftArrow },
            React__default['default'].createElement("button", { className: styles$6.button, onClick: goToPreviousMonth },
                React__default['default'].createElement(LeftArrowIcon, null))),
        React__default['default'].createElement("div", { className: styles$6.text }, monthYearString),
        React__default['default'].createElement("div", { className: styles$6.rightArrow },
            React__default['default'].createElement("button", { className: styles$6.button, onClick: goToNextMonth },
...
var Content$1 = function (_a) {
    ...
    return React__default['default'].createElement("div", { className: styles$3.container }, fromTimeList.map(function (t) {
        return React__default['default'].createElement("div", { className: styles$3.item + " " + getStyles(t.status), key: t.id, onClick: function () { return onClick(t); } }, t.text);
    }));
};
...
var Content = function (_a) {
    ...
    return React__default['default'].createElement("div", { className: styles$3.container }, toTimeList.map(function (t) {
        return React__default['default'].createElement("div", { className: styles$3.item + " " + getStyles(t.status), key: t.id, onClick: function () { return onClick(t); } }, t.text);
    }));
};
...
var MainContainer = function (_a) {
    ...
    return React__default['default'].createElement("div", { className: styles$a.container },
        React__default['default'].createElement(Main, { data: data }),
...
var DatePicker = function (_a) {
    ...
    return React__default['default'].createElement("div", { className: styles.container + " " + (status ? styles.show : styles.hide) },
        React__default['default'].createElement(MainContainer, { data: data }));
};
